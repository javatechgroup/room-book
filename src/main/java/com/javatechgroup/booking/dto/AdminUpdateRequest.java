...
public class AdminUpdateRequest {
    ...
    private String password; // Optional: only updated if non-empty
    ...
    public AdminUpdateRequest(String fullName, String email, String password, Long companyId, String status) {
