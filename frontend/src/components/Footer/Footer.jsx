...
import { Building2, ArrowUp, Mail, Phone, MapPin, Clock, LogIn, HelpCircle, ShieldCheck } from 'lucide-react';
    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__top">
          ...
          {/* Column 3: Campus & Facilities Info from Contact Section */}
          <div className="footer__column">
